...
import ServiceComp from "@/components/service/ServiceComp.vue";
import ItemComp from "@/components/service/ItemComp.vue";
...
export default {
  ...
  methods: {
    async refreshMeta() {
      const getResponse = await getMetaPage("service");
